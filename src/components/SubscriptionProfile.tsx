...
const SubscriptionProfile: React.FC = () => {
  return (
    <div className="flex flex-col items-center py-20 min-h-screen">
      <div className="bg-white shadow-lg rounded-xl p-10 w-full max-w-6xl text-center">
            ...
            <div className="h-full p-6 rounded-lg border-2 border-green-500 flex flex-col relative overflow-hidden">
              ...
              <div className="flex flex-col items-start text-left">
                ...
                <p className="flex items-center text-gray-600 mb-2">
                  ...
                  Puedes incrementar tu inversión o retirar el capital
                  libremente
                </p>
            ...
            <div className="h-full p-6 rounded-lg border-2 border-orange-500 flex flex-col relative overflow-hidden">
              ...
              <div className="flex flex-col items-start text-left">
                <p className="flex items-center text-gray-600 mb-2">
                  ...
                  Crea un historial exitoso de trading y atrae inversores
                </p>
                <p className="flex items-center text-gray-600 mb-2">
                  <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <FiCheckCircle size={16} color="#fff" />
                ...
                <p className="flex items-center text-gray-600 mb-2">
                  ...
                  Ganas comisiones sobre el capital asignado por los inversores
                </p>
                <p className="flex items-center text-gray-600 mb-6">
                  <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <FiCheckCircle size={16} color="#fff" />
              ...
              <Link
                ...
                target="_blank"
                className="flex items-center text-center justify-center mt-auto text-white bg-orange-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-orange-600 rounded"
              >
                Suscribirse
              </Link>
            </div>
